...
#define greenLed 14           // Pin para el LED verde (acceso concedido)
#define redLed 12             // Pin para el LED rojo (acceso denegado)
...
byte Usuario1[4] = {0xF6, 0xEF, 0x2E, 0x32}; // UID tarjeta CON acceso (reemplaza por tu UID)
