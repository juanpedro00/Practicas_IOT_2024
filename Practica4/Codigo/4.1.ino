...
#define TARGET_DEVICE_NAME "ESPMar"  // Cambiar según el nombre del emisor configurado
...
const float TEMP_THRESHOLD = 27.0;  // Cambiar según el umbral deseado
// ===============================================
